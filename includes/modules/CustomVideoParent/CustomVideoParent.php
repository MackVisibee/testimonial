 ...
 * @since 1.0.0
 */
class CustomVideoParent extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'custom_video_parent';

	// Full Visual Builder support
	public $vb_support = 'on';

	// Module item's slug
	public $child_slug = 'custom_video_parent_child';
	...
	/*function get_main_tabs() {
		$tabs = array(
			...
			'back'  => esc_html__( 'Arrière', 'm-custom-video' ),
	...
	function init() {
		// Module name
		$this->name = esc_html__( 'Home Slider', 'm-custom-video' );
		...
		$this->child_item_text	= esc_html__( 'slide item', 'm-custom-video' );
