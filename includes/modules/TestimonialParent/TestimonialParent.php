 ...
 * @since 1.0.0
 */
class TestimonialParent extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'testimonial_parent';

	// Full Visual Builder support
	public $vb_support = 'on';

	// Module item's slug
	public $child_slug = 'testimonial_child';
	...
	function init() {
		// Module name
		$this->name = esc_html__( 'Testimonials Slider', 'testimonial-slider' );
		...
		$this->child_item_text	= esc_html__( 'Member', 'testimonial-slider' );
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		$output = sprintf(
			'<div class="testimonials-slider__section">
				%1$S
			</div>',
			$this->content
		);
